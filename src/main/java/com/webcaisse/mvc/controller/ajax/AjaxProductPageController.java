...
import com.webcaisse.beans.commande.Paiement;
import com.webcaisse.beans.commande.panier.LignePanier;
import com.webcaisse.beans.produit.RemiseProduit;
import com.webcaisse.enums.commande.EnumModePaiement;
import com.webcaisse.mvc.controller.ajax.response.JsonFamillyResponse;
import com.webcaisse.mvc.controller.ajax.response.JsonPrixPanierResponse;
import com.webcaisse.mvc.controller.ajax.response.JsonProductResponse;
...
public class AjaxProductPageController {
	...
	@ResponseBody
	public JsonPrixPanierResponse calculerPrixPanier() {
		JsonPrixPanierResponse jsonPrixPanier = new JsonPrixPanierResponse();
		Double prixHt = 0D;
		Double prixTtc = 0D;
