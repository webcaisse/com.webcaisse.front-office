...
public class ParametragePageController {
	...
	public String sauvegarderParametres(ModelMap model,
			@ModelAttribute("parametreCaisseIn") ParametreCaisseIn parametreCaisseIn) {
	 ...
	 * @param parametreIn
	 */
	private void sauvegarderParam(String paramName, String paramValue,
			ParametreIn parametreIn) {
